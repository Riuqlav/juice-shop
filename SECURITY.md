...
OWASP Juice Shop is an _intentionally vulnerable_ web application, but we still do not want to be surprised by zero-day
vulnerabilities that are not part of our hacking challenges. We are following the proposed Internet
...
<https://tools.ietf.org/html/draft-foudil-securitytxt-06>. Finding it is one of our hacking challenges!
...
For vulnerabilities that are **not** part of any hacking challenge please contact <bjoern.kimminich@owasp.org>. In all
